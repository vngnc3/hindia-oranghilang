...
function showNotice(noticeObject) {
  ...
  notice.innerHTML = `
        ...
        \&nbsp;
        <br />
        <span class='dismissNote'>Sentuh di mana saja untuk kembali.</span>
    `;
...
const orangHilangHelp = {
  ...
  \&nbsp;
  <br/>
  Setiap kamu membuka halaman ini, salah satu dari ${getPermutations().toLocaleString()} jiwa yang hilang akan muncul di hadapanmu.<br />
